                    ...
                    <div class="scard">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-8">
                              <input id="textinput" name="textinput" type="text" placeholder="Phone no." class="form-control input-md">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <div class="col-md-5 col-md-offset-3">
                                <button id="singlebutton" name="singlebutton" class="btn btn-yellow btn-block">Register</button>
                              </div>
                            </div>
