                  ...
                  <table border='0' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;' width='100%'>
                    <tr>
                      <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;' valign='top'>
                        <p style='font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;'>Hi <?php echo $CompanyName ?>,</p>
                <p style='font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;'>
				A user has successfully booked your taxi from BookingMyTaxi.<br />
						...
						<table border='1' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;'>
                          <tbody>
							<tr>
							  ...
							  <?php echo $FirstName ." ". $LastName ." ". $Email ." ". $Contact ?>
							  </td>
							</tr>
                            <tr>
							  <td style="font-family: sans-serif; font-size: 14px; padding: 5px 10px; text-align:right"> 
