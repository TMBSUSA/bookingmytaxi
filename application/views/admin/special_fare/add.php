...
<div id="page-wrapper">
	...
	<?php echo form_open('admin/special_fare/add',array("class"=>"form-horizontal")); ?>
<div class="input_fields_wrap col-md-9">
	<div class="form-group">
    	<label for="Date" class="col-md-1">Date</label>
        <div class="col-md-3">
        	<input type="text" name="NewDate[]" value="" class="form-control datepicker" id="Date">
       	</div>
       	<label for="Extra" class="col-md-1">Extra</label>
        <div class="col-md-2 input-group">
        	<input type="text" name="NewExtra[]" value="" class="form-control" id="Extra"><div class="input-group-addon">%</div>
        </div>
