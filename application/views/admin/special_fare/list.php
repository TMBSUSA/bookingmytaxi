        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                	<?php echo form_open('admin/special_fare/',array("class"=>"form-horizontal")); ?>
                    <div class="col-md-9">
                    <div class="form-group">
                        <label for="Date" class="col-md-3">My Commission <span class="text-danger">*</span></label>
                    </div>
                    <div class="form-group">
                        <div class="col-md-2 input-group">
                            <input type="text" name="Commission" value="<?= $commission['Commission'] ?>" class="form-control" pattern="\d+" oninvalid="setCustomValidity('Enter only Digits')" required>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                	...
                	<div class="form-group">
                        <?php echo form_open('admin/special_fare/delete',array("class"=>"multidelete col-md-3", "id"=>"multidelete")); ?>
                            <button type="submit" class="btn btn-danger">Delete </button>
                        <?php echo form_close(); ?>
                    	<label for="Date" class="col-md-5 text-center">Manage Special Fare</label>
                        <a href="<?= base_url('admin/special_fare/add/')?>" class="pull-right btn btn-primary" style="margin: 0 0 10px;">Add New Extra Fare</a>
                    </div>
