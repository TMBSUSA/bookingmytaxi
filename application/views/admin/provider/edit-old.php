...
<div class="tab-content">
	<div id="basic_info" class="tab-pane fade in active">
        ...
        <div class="form-group">
            <label for="PostCode" class="col-md-2">Company Post Code <span class="text-danger">*</span></label>
            <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="ContractStartDate" value="<?php echo ($this->input->post('ContractStartDate') ? $this->input->post('ContractStartDate') : date("d-m-Y", strtotime($this->input->post('ContractStartDate')))); ?>" class="form-control datepicker" id="ContractStartDate" />
            </div>
        </div>
        <div class="form-group">
            <label for="ContractEndDate" class="col-md-2">Contract End Date</label>
            <div class="col-md-4">
                <input type="text" name="ContractEndDate" value="<?php echo ($this->input->post('ContractEndDate') ? $this->input->post('ContractEndDate') : date("d-m-Y", strtotime($this->input->post('ContractEndDate')))); ?>" class="form-control datepicker" id="ContractEndDate" />
            </div>
        </div>
    ...
    <div id="banking_details" class="tab-pane fade">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="Ownersdob" value="<?php echo ($this->input->post('Ownersdob') ? $this->input->post('Ownersdob') : date("d-m-Y", strtotime($this->input->post('Ownersdob')))); ?>" class="form-control datepicker" id="Ownersdob" required/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <select name="OwnersCity" class="form-control" required id="OwnerCity">
                    <option value="">Select City</option>
                    <?php 
                    foreach($cities as $city)
                    {
