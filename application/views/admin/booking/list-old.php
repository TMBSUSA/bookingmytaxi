            ...
            <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <?php echo form_open('admin/booking/action',array("class"=>"deletebooking pull-left", "id"=>"deletebooking")); ?>
                        	...
                        	<input type="submit" class="btn btn-success btn-sm margin7" name="action" value="Mark as Completed">
                            <input type="submit" class="btn btn-warning btn-sm margin7" name="action" value="Mark as Failed">
                        <?php echo form_close(); ?>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <tbody id="provider">
                            <?php if(!empty($providers)): foreach($providers as $b): ?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $b['CompanyName'] ." - ".$b['ContactNumber'] ; ?></td>
                                    <td><?php echo convert_date($b['StartDate']) ." ". $b['StartTime']; ?></td>
                                    <td><?php echo convert_price($b['TotalFare']); ?></td>
                                    <td><?php 
